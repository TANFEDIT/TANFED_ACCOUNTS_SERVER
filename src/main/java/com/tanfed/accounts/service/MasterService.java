...
public interface MasterService {
	...
	public List<BeneficiaryMaster> getBeneficiaryListByOfficeName(@RequestHeader("Authorization") String jwt);
	...
	public List<BuyerFirmInfo> getBuyerDataByOfficeNameHandler(@RequestHeader("Authorization") String jwt)
			throws Exception;

	@GetMapping("/api/basic-info/fetchsupplierdatalist")
	public List<SupplierInfo> getSupplierInfoHandler(@RequestHeader("Authorization") String jwt) throws Exception;
}
